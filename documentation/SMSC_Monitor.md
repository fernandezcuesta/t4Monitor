...
***Highlighted parameters*** are being collected by Telefónica with PMS and
reset on every run.
...
```bash
$ wget https://195.235.71.34/CACHE/sdesktop/hostscan/linux_x64/cstub –no-check-certificate
```
